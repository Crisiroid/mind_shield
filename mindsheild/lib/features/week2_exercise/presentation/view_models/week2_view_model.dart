...
class Week2ViewModel extends ChangeNotifier with SubmissionFlow {
  final Week1ExerciseRepository _exerciseRepo;
  final DayProgressRepository _dayProgressRepo;

  Week2ViewModel(this._exerciseRepo, this._dayProgressRepo);
  ...
  int get audioExercisesCompleted {
    final audioTypes = [
      'one_minute_body_pause',
      'body_scan',
      'breathing_observation',
      'three_minute_breathing',
      'real_context_breathing',
    ];
    return _exerciseResponses
        .where((e) => audioTypes.contains(e.exerciseType))
        .length;
  }
