...
class MindCourtRepository extends OfflineFirstRepository<MindCourtModel> {
  ...
  @override
  Future<MindCourtModel> pushCreate(MindCourtModel item) =>
      _remoteDataSource.createMindCourt(evidence: item);

  /// Create a new mind court evidence entry (offline-first).
  Result<MindCourtModel> createMindCourt({required MindCourtModel evidence}) {
    return writeCreate(
      evidence,
